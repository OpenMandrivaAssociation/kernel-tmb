...
* Tue Dec  7 2010 Thomas Backlund <tmb@mandriva.org> 2.6.37-0.rc5.1mdv
...
- add patches:
    * AA01: 2.6.33-rc3+ git 2c1f1895ef2aa8f0e5497893eff71304aef332e1
      - a lot of drm fixes
    * NM03: mac80211 skb buffering buildfix (fixes oops on boot)

* Wed Jan 06 2010 Thomas Backlund <tmb@mandriva.org> 2.6.33-0.rc3.1mdv
- update to 2.6.33-rc3
- add patches:
    * NM01, NM02: fix mac80211 skb buffering performance regression

* Tue Jan 05 2010 Thomas Backlund <tmb@mandriva.org> 2.6.33-0.rc2.6.5mdv
- update to 2.6.33-rc2-git6
- drop patches:
    * AA01: 2.6.33-rc2-git2
- add patches:
    * AX01: fix un-bootable dell systems due to unactivated iommu
    * DS50: add Broadcom CrystalHD support
    * FS10: squashfs lzma support
- update defconfigs
...
- add patches:
    ...
    * DS01: Alsa 1.0.22+ snapshot 2009-12-28
- update patches:
    * DI01: lirc for 2.6.33-rc2
    * DS10: Alsa unstable Via 1732
    * KP01: tuxonice 3.0.99.44 for-2.6.33-rc2
- drop patches:
...
- add patches:
    * DG11: drm/radeon/kms: Move radeon_get_clock_info() call
	    out of radeon_clocks_init() (Thierry)
    * DH11: hwmon: add Intel Lynnfield support to coretemp
- require kernel-firmware >= 20090604-2mnb to get the radeon
  firmware that is now splitted out in drm-next
...
* Mon Jul 20 2009 Thomas Backlund <tmb@mandriva.org> 2.6.31-0.rc3.4.3mdv
- update to 2.6.31-rc3-git4

* Thu Jul 16 2009 Thomas Backlund <tmb@mandriva.org> 2.6.31-0.rc3.3.2mdv
- update to 2.6.31-rc3-git3
- add patches:
    * DP01: fix acer-wmi reversed rfkill
    * NR01: rfkill: fix rfkill_set_states to set the hw state

* Tue Jul 14 2009 Thomas Backlund <tmb@mandriva.org> 2.6.31-0.rc3.1mdv
